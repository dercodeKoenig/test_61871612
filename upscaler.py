...
def upscale(img, scale, captions):
    ...
    with torch.no_grad():
        samples = model.batchify_sample(
            ...
            num_samples=1,
            p_p=' high quality, highly detailed, ultra HD, Cinematic, 32k, perfect without deformations.',
            n_p='blurry, messy, noisy, deformed, lowres, low quality, grainy, distorted, artifacts, bad anatomy, malformed hands',
